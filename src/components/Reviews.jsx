        ...
        <div className="grid md:grid-cols-3 gap-8">
          {reviews.map((review, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="p-6 rounded-2xl border border-gray-100 bg-white shadow-md hover:shadow-xl transition-all duration-300"
            >
              <div className="flex justify-between items-start mb-4">
                 <div className="flex items-center gap-3">
                   {/* Avatar */}
                   <div className="w-10 h-10 rounded-full flex items-center justify-center font-bold text-white bg-blue-600">
              ...
              <div className="flex gap-0.5 mb-3">
                {[...Array(review.rating)].map((_, i) => (
                  <svg key={i} className="w-4 h-4 text-[#FBBC04] fill-current" viewBox="0 0 20 20">
