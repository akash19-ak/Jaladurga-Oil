      ...
      <div className="container grid md:grid-cols-2 gap-12 items-center relative z-10">
        ...
        >
          ...
          <h1 className="text-5xl md:text-7xl mb-6 leading-[1.1]">
            Jaladurga <br />
            <span className="text-primary italic">Cold Pressed</span> <br />
            Coconut Oil
          </h1>
        ...
        >
          <div className="relative z-10 floating">
            <div className="w-[300px] h-[400px] md:w-[400px] md:h-[500px] bg-primary rounded-3xl overflow-hidden shadow-2xl transform rotate-3 relative">
               {/* Image placeholder or 3D element */}
               <div className="absolute inset-0 bg-gradient-to-br from-primary/80 to-primary flex items-center justify-center p-8 text-center text-white">
                 <div>
